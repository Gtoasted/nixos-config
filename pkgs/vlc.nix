# https://github.com/NixOS/nixpkgs/blob/nixos-24.11/pkgs/by-name/vl/vlc/package.nix#L326
{
  autoPatchelfHook,
  lib,
  SDL,
...
stdenv.mkDerivation (finalAttrs: {
  ...
  postFixup =
    ...
    ''
      # ls ${makemkv}/bin/makemkv
      # export LIBAACS_PATH=$out/lib/libmmbd.so.0
      # export LIBBDPLUS_PATH=$out/lib/libmmbd.so.0
      # export MAKEMKVCON=$out/bin/makemkvcon
